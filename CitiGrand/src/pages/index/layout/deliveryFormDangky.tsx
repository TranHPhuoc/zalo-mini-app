...
export const DeliveryFormDangKy: FC = () => {
  ...
  const img =
  "https://res.cloudinary.com/dl4szj3ff/image/upload/v1743560118/CitiGrand/vq0rww5nc7hgygvcjw06.jpg";
  ...
  return (
    <Box className="space-y-3 p-4">
      ...
      <Modal visible={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <Box className="p-1">
          <Text className="text-xl uppercase font-bold text-[#405f25] text-center mb-5">
            Đăng ký tư vấn
          </Text>
          <ElasticTextarea
