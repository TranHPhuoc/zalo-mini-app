...
export const Object: FC = () => {
    const data = [
        ...
        {
            dot: '1',
            thoiDiem: 'Ký Hợp đồng mua bán nhà ở (Trong vòng 10 ngày kể từ ngày đặt cọc)',
        ...
        {
            dot: '7',
            thoiDiem: 'Trong vòng 180 ngày kể từ ngày ký HĐMB - Khách hàng nhận bàn giao nhà ở thực tế',
    ...
    return (
        <Box className="m-4">
            ...
            <br />
            <table className="w-full border-collapse border giaBan text-content" style={{ height: '232px' }}>
                <thead>
                    <tr style={{ height: '43px' }} className="text-[#4a5d52]">
                        ...
                        <th className="text-center" style={{ width: '37.5393%' }}>
                            <strong>TỶ LỆ THANH TOÁN</strong><br />
