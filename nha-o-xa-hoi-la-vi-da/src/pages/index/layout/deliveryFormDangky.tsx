...
export const DeliveryFormDangKy: FC = () => {
  ...
  const handleSendOrder = async () => {
    ...
    try {
      const API_URL = "https://pro.n8n.vn/webhook-test/miniapp-lark-1";
      ...
      >
        ...
        <div>
          <ElasticTextarea
            ...
            value={formData.name}
            onChange={(e) =>
              handleInputChange("name", (e.target as HTMLTextAreaElement).value)
            }
          />
          ...
          <ElasticTextarea
            ...
            value={formData.note}
            onChange={(e) =>
              handleInputChange("note", (e.target as HTMLTextAreaElement).value)
            }
          />
        </div>
        <Button
