...
export const Symptom3: FC = () => {
    const img1 = "https://res.cloudinary.com/dfzc1gkqr/image/upload/v1726737316/Nh%C3%A0%20%E1%BB%9E%20X%C3%A3%20H%E1%BB%99i%20-%20New%20LaVIDA/b3wplcgvpgrruwppczgj.png"
    return (
        <Box className="m-1 bg-[#387270]">
            ...
            <div className="text-center text-white">
                <p>Nét đẹp tinh tế của kiến trúc tân cổ điển Châu Âu với điểm nhấn mái Mansard biểu trưng cho sự giao hòa Đông – Tây được tái hiện hoàn mỹ qua những dãy phố mang vẻ đẹp cân bằng giữa hoài cổ và hiện đại, sang trọng và bình yên mà bất cứ ai cũng say lòng khi ngắm nhìn.</p>
            </div>
            <PlanList />
            <div>
                <img src={img1} alt="" />
        ...
        <Box className="p-3">
            ...
            >
                {plans.map((plan) => (
                    ...
                    >
                        <span
                            className="number text-center w-[calc(30/1920*100rem)] min-w-[calc(30/1920*100rem)] h-[calc(30/1920*100rem)] flex-center border border-solid border-[#ffdb8f] bg-transparent mr-[calc(10/1920*100rem)] rounded-full xl:text-[calc(14/1920*100rem)]"
                        >
                            {plan.id}
                        </span>
