  ...
  return (
    <Box className="m-4">
      ...
      <div className="font-content text-[#4a5d52]">
        <strong>
          Giá bán biệt thự và nhà phố The Classia mới nhất tháng 01/2024{" "}
        </strong>
        <span className="text-black">
          tham khảo chỉ 18.8 TỶ/ CĂN ĐÃ BAO GỒM VAT ! Giá bán The Classia Khang
          Điền 18,8 tỷ gồm VAT là chưa trừ chiết khấu 7,3% và chính sách quà
          tặng… Quý khách hàng có thể liên hệ PKD để được tư vấn chi tiết hơn.
          Với những ưu điểm về quy mô, vị trí tọa lạc, thiết kế và những tiện
          ích đẳng cấp đi kèm, Foresta quận 9
        </span>
      </div>
      <br />
      <div className="font-content text-[#4a5d52] text-[16px] text-center">
        <strong>
          Giá bán biệt thự và nhà phố The Classia Khang Điền tháng 03/2024
        </strong>
      </div>
      <br />
      <table
