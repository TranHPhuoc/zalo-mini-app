...
import logo1 from "static/Viva-House-Green-Town-Logo.png";
import logo from "static/logo-gp-land.png";
import nen1 from "static/bg.citigrand.png";
...
const ServicesOfUs: FC = () => {
  ...
  return (
    <Box className="space-y-3 m-2 p-3" style={{ background: "linear-gradient(to top, #30726f, #e6f8ff)"}}>
      <div className="flex justify-between items-center">
        <img src={logo1} alt="" style={{ width: "100px", height: "auto" }} />
